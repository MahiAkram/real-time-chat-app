...
const SignUpPage = () => {
  ...
  const validateFrom = () => {
    if (!formData.fullName.trim())
      return toast.error("Please insert your name");
    if (!formData.email.trim()) return toast.error("Please insert your email");
    if (!/\S+@\S+\.\S+/.test(formData.email))
      return toast.error("Please insert a valid email");
    if (!formData.password) return toast.error("Please insert a password");
